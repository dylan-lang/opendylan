...
copyright = u'2012-2023, Dylan Hackers'
...
latex_documents = [
  ('index', 'OpenDylan.tex', u'Open Dylan Documentation',
...
texinfo_documents = [
  ('index', 'OpenDylan', u'Open Dylan Documentation',
   u'Dylan Hackers', 'OpenDylan', 'One line description of project.',
   'Miscellaneous'),
]
