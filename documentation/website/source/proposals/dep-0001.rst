...
Dylan Reference Manual (DRM)
    The manual written by Andrew Shallit, plus its errata.

Dylan language specification
    The DRM *plus* any **Accepted** DEPs that modify the Dylan
...
Standard libraries
    ...
    Dylan.  They are officially maintained in follow sense:
