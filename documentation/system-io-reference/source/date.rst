...
Creates an instance of the `<date> <date.htm#54319>`_ class.
...
dates <date.htm#67195>`_ for details.
...
instances of `<year/month-duration> <date.htm#94326>`_ can cause
...
`date-month <date.htm#38093>`_

`date-day <date.htm#93614>`_

`date-day-of-week <date.htm#50792>`_

`date-hours <date.htm#42838>`_

`date-minutes <date.htm#56225>`_

`date-seconds <date.htm#98180>`_

`date-microseconds <date.htm#57573>`_

`date-time-zone-offset <date.htm#32103>`_
...
-  *date1* An instance of `<date> <date.htm#54319>`_.
-  *date2* An instance of `<date> <date.htm#54319>`_.
...
-  *duration1* An instance of `<duration> <date.htm#58206>`_.
-  *duration2* An instance of `<duration> <date.htm#58206>`_.
...
<day/time-duration> <date.htm#42580>`_, any differences in microseconds
...
This method determines if *duration1* is less than *duration2*. If the
durations are actually instances of `
<day/time-duration> <date.htm#42580>`_, any differences in microseconds
between *duration1* and *duration2* are ignored.
...
-  *arg2* An instance of `<date> <date.htm#54319>`_ or `
   <duration> <date.htm#58206>`_. See description for details.

Values
      

-  *sum* An instance of `<date> <date.htm#54319>`_ or `
   <duration> <date.htm#58206>`_. See description for details.
...
-  *diff* An instance of `<date> <date.htm#54319>`_ or `
   <duration> <date.htm#58206>`_. See description for details.
...
-  *new-duration* An instance of `<date> <date.htm#54319>`_ or `
   <duration> <date.htm#58206>`_. See description for details.
...
The *iso8601-string* init-keyword for `<date> <date.htm#54319>`_,
however, accepts ISO 8601 strings with other time zone specifications.

See also
        

`<date> <date.htm#54319>`_
...
`= <date.htm#38838>`_ `< <date.htm#62218>`_ `
+ <date.htm#87346>`_ `- <date.htm#38426>`_ `
as-iso8601-string <date.htm#12302>`_ `
current-date <date.htm#79399>`_ `date-day <date.htm#93614>`_
 `date-day-of-week <date.htm#50792>`_ `
date-hours <date.htm#42838>`_ `date-microseconds <date.htm#57573>`_
 `date-minutes <date.htm#56225>`_ `date-month <date.htm#38093>`_
`date-seconds <date.htm#98180>`_
 `date-time-zone-offset <date.htm#32103>`_ `
date-time-zone-offset-setter <date.htm#29004>`_
 `date-year <date.htm#67898>`_ `decode-date <date.htm#41874>`_
...
example, if passed a `<date> <date.htm#54319>`_ that represented
16:36 on the 20th June, 1997, *date-day* returns the value 20.

See also
        

`decode-date <date.htm#41874>`_
...
init-keyword when the `<date> <date.htm#54319>`_ object was created.
...
when the `<date> <date.htm#54319>`_ object was created.
...
date-day-of-week <date.htm#50792>`_ function.
...
is a subclass of `<duration> <date.htm#58206>`_.
...
use `<year/month-duration> <date.htm#94326>`_ instead.

Operations
          

`< <date.htm#22140>`_ `+ <date.htm#87346>`_ `
- <date.htm#38426>`_ `decode-duration <date.htm#52143>`_ `
encode-day/time-duration <date.htm#49385>`_
...
`<year/month-duration> <date.htm#94326>`_
...
`decode-duration <date.htm#60571>`_

`decode-duration <date.htm#52143>`_
...
-  *duration* An instance of `
   <day/time-duration> <date.htm#42580>`_.
...
`decode-duration <date.htm#47241>`_
...
`encode-year/month-duration <date.htm#23257>`_
...
`= <date.htm#71288>`_ `< <date.htm#22140>`_ `
+ <date.htm#87346>`_ `- <date.htm#38426>`_ `
\* <date.htm#16874>`_ `/ <date.htm#26355>`_
...
`local-time-zone-offset <date.htm#75440>`_

`make date-class <date.htm#99637>`_
...
-  *date-class* The class `<date> <date.htm#54319>`_.
-  *iso8601-string* An instance of *false-or(<string>)*. Default value:
   *#f*.
-  *year* An instance of *limited(<integer>, min: 1800, max: 2199)*.
-  *month* An instance of *limited(<integer>, min: 1, max: 12)*.
...
-  *date-instance* An instance of `<date> <date.htm#54319>`_.

Description
           

Creates an instance of `<date> <date.htm#54319>`_.

The make method on `<date> <date.htm#54319>`_ takes the same
keywords as the `<date> <date.htm#54319>`_ class.

*Note:* The iso8601-string keyword accepts a richer subset of the ISO
8601 specification than is produced by the `
as-iso8601-string <date.htm#12302>`_ function.
...
and months. It is a subclass of `<duration> <date.htm#58206>`_.
...
(to microsecond resolution), use `
<day/time-duration> <date.htm#42580>`_ instead.

Operations
          

`< <date.htm#22140>`_ `+ <date.htm#87346>`_ `
- <date.htm#38426>`_ `decode-duration <date.htm#60571>`_ `
encode-year/month-duration <date.htm#23257>`_
