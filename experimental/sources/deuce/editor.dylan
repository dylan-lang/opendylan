...
// hughg, 1999/07/29: The type <incremental-search-direction> was originally
// defined in isearch.dylan, but was moved here to get round forward-reference
// problems (which only show up in loose-mode compilation).
