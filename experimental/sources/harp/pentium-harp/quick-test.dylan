...
define method output-first-literal (be :: <pentium-back-end>, outputter)
...
define method output-second-literal (be :: <pentium-back-end>, outputter)
...
define method output-two-literals (be :: <pentium-back-end>, outputter)
  output-first-literal(be, outputter);
  output-second-literal(be, outputter);
end method;


define lambda-test call-internal-test (be :: <pentium-back-end>)
...
define lambda-test return-first-literal (be :: <pentium-back-end>)
  name "first_lit_iep"; 
  start-line 5; 
  end-line 10;
...
define lambda-test qtest0 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest1 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest2 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest3 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest4 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest5 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest6 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest7 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest8 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 20;
...
define lambda-test qtest9 (be :: <pentium-back-end>)
  name *test-name*;
  start-line 13;
  end-line 27;
