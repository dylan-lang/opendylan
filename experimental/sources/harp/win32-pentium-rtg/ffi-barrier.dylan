...
define sideways method op--get-teb-tlv
    (be :: <windows-pentium-back-end>, dest :: <register>) => ()
  with-harp (be)
    c-result c-result;
...
define sideways method op--set-teb-tlv
    (be :: <windows-pentium-back-end>, val) => ()
  with-harp (be)
...
define sideways method op--get-module-handle(be :: <windows-pentium-back-end>) => ()
  with-harp (be)
    c-result c-result;
...
define sideways method op--init-dylan-data (be :: <windows-pentium-back-end>) => ()
  with-harp (be)
