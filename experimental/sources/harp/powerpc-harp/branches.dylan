...
define powerpc-template (strong-scl)
...
define method emit-scl 
    (be :: <powerpc-back-end>, locator, named-registers :: <simple-object-vector>)
     => ()
