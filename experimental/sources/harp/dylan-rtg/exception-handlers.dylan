...
/// here. Their job is then to signal an appropriate error. The choice
/// of error class is currently pretty basic (<simple-error> for float
/// error).
...
define runtime-literal float-overflow-error-string 
  = "float-overflow-error-string", data: "Float overflow error.";

define runtime-literal float-underflow-error-string 
  = "float-underflow-error-string", data: "Float underflow error.";

define runtime-literal float-divide-0-error-string 
  = "float-divide-0-error-string", data: "Float divide by 0 error.";
...
define c-runtime-primitive dylan-float-divide-0-handler
  ...
  op--call-xep(be, dylan-error-function, float-divide-0-error-string);
...
define c-runtime-primitive dylan-float-overflow-handler
  ...
  ins--clear-float-exceptions(be);
  op--call-xep(be, dylan-error-function, float-overflow-error-string);
...
define c-runtime-primitive dylan-float-underflow-handler
  ...
  ins--clear-float-exceptions(be);
  op--call-xep(be, dylan-error-function, float-underflow-error-string);
