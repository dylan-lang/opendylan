...
define sideways method op--get-teb-tlv
    (be :: <linux-pentium-back-end>, dest :: <register>) => ()
  with-harp (be)
...
define sideways method op--get-module-handle(be :: <linux-pentium-back-end>) => ()
end method;
...
define sideways method op--init-dylan-data (be :: <linux-pentium-back-end>) => ()
  with-harp (be)
