...
define variable *pentium-back-end* = #f;


define method current-pentium-back-end()
  *pentium-back-end*
end method;

// Switch a pentium-back-end dynamically, e.g. from
// Windows to Linux

define method current-pentium-back-end-setter
    (back-end-class :: subclass(<pentium-back-end>))

  *pentium-back-end* := make(back-end-class);
  default-back-end() := *pentium-back-end*;
  *harp-back-end* := *pentium-back-end*;

end method;

current-pentium-back-end() := <pentium-back-end>;


define sideways method estimate-harp-virtual-registers-size
    (backend :: <pentium-back-end>, o :: <&iep>) => (size :: <integer>)
...
define sideways method c-name
    (back-end :: <linux-pentium-back-end>, name :: <string>) => (name :: <string>)
 name
end method c-name;


define sideways method shared-library-entry-point-name
    (back-end :: <pentium-back-end>, name :: <string>) => (name :: <string>)
...
define sideways method emit-imported-name
    (back-end :: <pentium-back-end>, stream, o) => (name :: <string>)
...
define sideways method emit-imported-name
    (back-end :: <linux-pentium-back-end>, stream, o) => (name :: <string>)
...
define sideways method make-imported-constant-reference
    (back-end :: <linux-pentium-back-end>, o,
...
define sideways method emit-import-adjustment?
    (back-end :: <linux-pentium-back-end>) => (adjust? :: <boolean>)
  #f
...
define sideways method emit-data-footer
    (back-end :: <linux-pentium-back-end>, stream, name,
...
define sideways method emit-imports
    (back-end :: <linux-pentium-back-end>, cr, ld :: <library-description>) => ()
end method;

define sideways method emit-library-imported-data
    (back-end :: <linux-pentium-back-end>, stream, description :: <library-description>,
