...
define &primitive-descriptor primitive-single-float-log, emitter: ins--floge;
define &primitive-descriptor primitive-single-float-exp, emitter: ins--fetox;
define &primitive-descriptor primitive-single-float-expt, emitter: op--single-float-expt;
define &primitive-descriptor primitive-single-float-sin, emitter: ins--fsin;
define &primitive-descriptor primitive-single-float-cos, emitter: ins--fcos;
define &primitive-descriptor primitive-single-float-tan, emitter: ins--ftan;
define &primitive-descriptor primitive-single-float-asin, emitter: ins--fasin;
define &primitive-descriptor primitive-single-float-acos, emitter: ins--facos;
define &primitive-descriptor primitive-single-float-atan, emitter: ins--fatan;
...
define &primitive-descriptor primitive-double-float-log, emitter: ins--dloge;
define &primitive-descriptor primitive-double-float-exp, emitter: ins--detox;
define &primitive-descriptor primitive-double-float-expt, emitter: op--double-float-expt;
define &primitive-descriptor primitive-double-float-sin, emitter: ins--dsin;
define &primitive-descriptor primitive-double-float-cos, emitter: ins--dcos;
define &primitive-descriptor primitive-double-float-tan, emitter: ins--dtan;
define &primitive-descriptor primitive-double-float-asin, emitter: ins--dasin;
define &primitive-descriptor primitive-double-float-acos, emitter: ins--dacos;
define &primitive-descriptor primitive-double-float-atan, emitter: ins--datan;
