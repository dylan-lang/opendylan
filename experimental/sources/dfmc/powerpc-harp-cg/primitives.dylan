...
define sideways method op--wait-for-simple-lock(back-end :: <powerpc-back-end>, result, lock, #key zmilsecs) => ()
...
define sideways method op--wait-for-simple-lock-timed(back-end :: <powerpc-back-end>, result, lock, zmilsecs) => ()
...
define sideways method op--release-simple-lock(back-end :: <powerpc-back-end>, result, lock) => ()
...
define sideways method op--wait-for-recursive-lock(back-end :: <powerpc-back-end>, result, lock, #key zmilsecs) => ()
...
define sideways method op--wait-for-recursive-lock-timed(back-end :: <powerpc-back-end>, result, lock, zmilsecs) => ()
...
define sideways method op--release-recursive-lock(back-end :: <powerpc-back-end>, result, lock) => ()
...
define sideways method op--write-thread-variable(back-end :: <powerpc-back-end>, result, variable-handle, new-value) => ()
...
define sideways method op--read-thread-variable(back-end :: <powerpc-back-end>, result, variable-handle) => ()
...
define sideways method op--allocation-count(back-end :: <powerpc-back-end>, result) => ()
  ins--ld-teb(back-end, result, -4);
end method;

define sideways method op--initialize-allocation-count(back-end :: <powerpc-back-end>, result) => ()
