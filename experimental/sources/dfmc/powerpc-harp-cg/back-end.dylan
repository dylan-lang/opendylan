...
define variable *powerpc-back-end* = #f;


define method current-powerpc-back-end()
  *powerpc-back-end*
end method;

// Switch a powerpc-back-end dynamically, e.g. from
// Windows to Linux

define method current-powerpc-back-end-setter
    (back-end-class :: subclass(<powerpc-back-end>))

  *powerpc-back-end* := make(back-end-class);
  default-back-end() := *powerpc-back-end*;
  *harp-back-end* := *powerpc-back-end*;

end method;

current-powerpc-back-end() := <powerpc-back-end>;


define sideways method estimate-harp-virtual-registers-size
    (backend :: <powerpc-back-end>, o :: <&iep>) => (size :: <integer>)
...
define sideways method c-name
    (back-end :: <linux-powerpc-back-end>, name :: <string>) => (name :: <string>)
 name
end method c-name;


define sideways method shared-library-entry-point-name
    (back-end :: <powerpc-back-end>, name :: <string>) => (name :: <string>)
...
define sideways method emit-imported-name
    (back-end :: <powerpc-back-end>, stream, o) => (name :: <string>)
...
define sideways method emit-imported-name
    (back-end :: <linux-powerpc-back-end>, stream, o) => (name :: <string>)
...
define sideways method make-imported-constant-reference
    (back-end :: <linux-powerpc-back-end>, o,
...
define sideways method emit-import-adjustment?
    (back-end :: <linux-powerpc-back-end>) => (adjust? :: <boolean>)
  #f
...
define sideways method emit-data-footer
    (back-end :: <linux-powerpc-back-end>, stream, name,
...
define sideways method emit-imports
    (back-end :: <linux-powerpc-back-end>, cr, ld :: <library-description>) => ()
end method;

define sideways method emit-library-imported-data
    (back-end :: <linux-powerpc-back-end>, stream, description :: <library-description>,
...
define sideways method op--cleanup-preserve-state-entry
  ...
  ins--save-return-address(back-end)
end method;

define sideways method op--cleanup-preserve-state-exit
    (back-end :: <powerpc-back-end>) => ()
  ins--restore-return-address(back-end)
end method;
