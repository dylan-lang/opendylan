...
define sideways method op--bmvset(back-end :: <powerpc-back-end>, tag :: <tag>) => ()
  ins--bmvset(back-end, tag);
end method;


define program-warning <powerpc-harp-warning>
  slot condition-description, required-init-keyword: description:;
  format-string "%s";
  format-arguments description;
end;

define sideways method harp-warning (be :: <powerpc-back-end>, #rest args)
  note(<powerpc-harp-warning>,
