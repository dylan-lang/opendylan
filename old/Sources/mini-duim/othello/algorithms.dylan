...
define method algorithm-title
    (algorithm :: <algorithm>) => (title :: <string>)
  $algorithms[algorithm]
end method algorithm-title;

define method all-algorithms () => (algorithms :: <sequence>)
  key-sequence($algorithms)
end method all-algorithms;
...
//---*** Replace this with a real random implementation
...
define method choose-move-for-player
    (algorithm == #"minimize-opponents-choices",
     board :: <othello-board>, player :: <player>, all-moves :: <sequence>)
 => (move :: false-or(<sequence>))
  let temp-board = make(<othello-board>, size: othello-board-size(board));
  let other-player = other-player(player);
  let no-of-squares = othello-board-no-of-squares(board);
  ...
  choose-move-for-player(#"random", board, player, best-moves)
end method minimize-opponents-choices;


/// 'Corner aware algorithm' players

define method play-algorithm-aware-of-corners
    (algorithm :: <algorithm>, board :: <othello-board>, player :: <player>,
     all-moves :: <sequence>)
 => (move :: false-or(<sequence>))
