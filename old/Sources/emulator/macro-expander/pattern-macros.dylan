...
#|
 ...
 Example:
   ...
   define pattern <slot-access-fragment> (<call-fragment>)
     pattern slots function, arguments;
   end fragment;
...
(define-infix-macro pattern <defining-word> (form) ()
  ((_ ?mods ?name (?super ...) ?slot ...)
	...
	(syntax-case slot (slot slots pattern source properties)
          ((pattern slots ?var ...)
