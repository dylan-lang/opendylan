...
(setq last-kbd-macro
   "config -b /home/nosa/dylan\C-mcd /home/nosa/dylan/sources/lib/run-time/powerpc\C-m")
(call-last-kbd-macro)
...
(insert "config-dylan")
(comint-send-input)
(insert "cd /home/nosa/dylan/build/basic-powerpc-dw")
(comint-send-input)
...
(find-file "~/dylan/sources/lib/run-time/powerpc")
(beginning-of-buffer)
(dired-sort-toggle-or-edit)
