...
sourcesdir=$dylandir/sources;          export sourcesdir
localdir=$dylandir/local;              export localdir
toolsdir=$dylandir/tools;              export toolsdir
admindir=$dylandir/admin/builds;       export admindir
logsdir=$admindir/logs;                export logsdir
qadir=$dylandir/sources/qa;            export qadir
