...
- ``console/factorial`` demonstrates integer operations and composing libraries. ``factorial-big.lid`` and `factorial-small.lib`` use the same base code to produce multiple applications with different integer internals.
