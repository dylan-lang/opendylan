...
! $HopeName: D-macos-interface!patterns.pat(trunk.4) $
! $Date: 2004/03/12 00:09:26 $
...
enumbody:\/\*<comment>\*\/=
enumbody:<S>=
enumbody:<I>\W\=\W<I>\W\|\W<number><space><term>=\
	define inline-only constant @export{\$$1} @tab{56}\= \%logior\(\$@map-name{$2}\, $3\)\;\n
enumbody:<I>\W\=\W<I>\W\|\W<I>\W\|\W<I><space><term>=\
	define inline-only constant @export{\$$1} @tab{56}\= \
        \%logior\(\$@map-name{$2}\, \$@map-name{$3}\, \$@map-name{$4}\)\;\n
enumbody:<I>\W\=\W<I>\W\|\W<I>\W\|\W<I>\W\|\W<I><space><term>=\
	define inline-only constant @export{\$$1} @tab{56}\= \
        \%logior\(\$@map-name{$2}\, \$@map-name{$3}\, \$@map-name{$4}\, \$@map-name{$5}\)\;\n
...
enumbody:<I>\W\=\W1L\W\<\<\W<number>\W<space><term>=\
	define inline-only constant @export{\$$1} @tab{56}\
        \= ash\(1, $2\)\;\n
enumbody:<I>\W\=\W1L\W\<\<\W<I>\W<term>=\
	define inline-only constant @export{\$$1} @tab{56}\
        \= ash\(1, \$@map-name{$2}\)\;\n
enumbody:<I>\W\=\W\(\W1L\W\<\<\W<number>\W\)\W<space><term>=\
	define inline-only constant @export{\$$1} @tab{56}\
        \= ash\(1, $2\)\;\n
enumbody:<I>\W\=\W\(\W1\W\<\<\W<number>\W\)\W<space><term>=\
	define inline-only constant @export{\$$1} @tab{56}\
        \= ash\(1, $2\)\;\n
...
EXTERN_API\(\Wvoid\W\)\W<relevant-function>\G(<args>)<trap>\;=\
...
EXTERN_API_STDCALL\(\Wvoid\W\)\W<relevant-function>\G(<args>)<trap>\;=\
	\N\ndefine inline-only C-function @export{$1}\n$2\N\
        \ \ c-name\: \"$1\"\;\n\
        \ \ c-modifiers\: \"pascal\"\;\n\
	end\;\n
...
EXTERN_API_C\(\Wvoid\W\)\W<relevant-function>\G(<args>)<trap>\;=\
	\N\ndefine inline-only C-function @export{$1}\n$2\N\
        \ \ c-name\: \"$1\"\;\n\
	end\;\n
...
EXTERN_API_C_STDCALL\(\Wvoid\W\)\W<relevant-function>\G(<args>)<trap>\;=\
	\N\ndefine inline-only C-function @export{$1}\n$2\N\
        \ \ c-name\: \"$1\"\;\n\
	end\;\n
...
putparm:<reserved>,*=parameter $1 @tab{24}\:\: $2\;\n
...
reserved:define=define\%${argnum}@incr{argnum}@end
reserved:end=end\%${argnum}@incr{argnum}@end
reserved:handler=handler\%${argnum}@incr{argnum}@end
reserved:let=let\%${argnum}@incr{argnum}@end
reserved:local=local\%${argnum}@incr{argnum}@end
reserved:macro=macro\%${argnum}@incr{argnum}@end
reserved:method=method\%${argnum}@incr{argnum}@end
reserved:otherwise=otherwise\%${argnum}@incr{argnum}@end
reserved:=@fail
...
struct\I\W<relevant-name><space>\{<matchparen2>\}\;=\
	@bind{sclass;@map-name{$1}}@bind{fields;@fields{$3}}\N\n\
...
typedef<space>struct\I\W<i><space>\{<matchparen2>\}\W<relevant-name><term>*\;=\
	@bind{sclass;@map-name{$5}}@bind{fields;@fields{$4}}\N\n\
	define C-struct @export{\<${sclass}\>}\n${fields}\N${packing}\
...
union\I\W<relevant-name><space>\{<matchparen2>\}\;=\N\n\
	@bind{sclass;@map-name{$1}}@bind{fields;@fields{$3}}\
	define C-union @export{\<${sclass}\>}\n${fields}\N${packing}\
	end\;\
	@unbind{sclass}@unbind{fields}
typedef union\I\W<i><space>\{<matchparen2>\}\W<relevant-name><term>*\;=\N\n\
	@bind{sclass;@map-name{$4}}@bind{fields;@fields{$3}}\
	define C-union @export{\<${sclass}\>}\n${fields}\N${packing}\
	end\;\
	\N@styps{*}\N@unbind{sclass}@unbind{fields}
fields:\S=
...
false-flag:OLDROUTINENAMES=$0@end
