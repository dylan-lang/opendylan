...
define C-pointer-type <DeviceLoopFlags**> => <DeviceLoopFlags*>;
define inline constant <PrinterStatusOpcode> = <SInt32>;
define C-pointer-type <PrinterStatusOpcode*> => <PrinterStatusOpcode>;
define C-pointer-type <PrinterStatusOpcode**> => <PrinterStatusOpcode*>;
// unnamed enum:
define inline-only constant $kPrinterFontStatus        = 0;
define inline-only constant $kPrinterScalingStatus     = 1;


define C-struct <PrinterFontStatus>
  sealed inline-only slot oResult-value  :: <SInt32>;
  sealed inline-only slot iFondID-value  :: <SInt16>;
  sealed inline-only slot iStyle-value   :: <Style>;
  pack: 2;
  c-name: "struct PrinterFontStatus";
end;
define C-pointer-type <PrinterFontStatus*> => <PrinterFontStatus>;
define C-pointer-type <PrinterFontStatus**> => <PrinterFontStatus*>;

define C-struct <PrinterScalingStatus>
  sealed inline-only slot oScalingFactors-value :: <Point>;
  pack: 2;
  c-name: "struct PrinterScalingStatus";
end;
define C-pointer-type <PrinterScalingStatus*> => <PrinterScalingStatus>;
define C-pointer-type <PrinterScalingStatus**> => <PrinterScalingStatus*>;
...
define C-struct <PixMapExtension>
  ...
  sealed inline-only slot longRowBytes-value :: <C-both-long>;
  pack: 2;
...
define C-struct <GDevice>
  ...
  sealed inline-only slot gdNextGD-value :: <GDHandle>;
...
define constant <QDPrinterStatusProcPtr> = <C-function-pointer>;
define constant <QDPrinterStatusUPP> = <UniversalProcPtr>;
...
define C-struct <CQDProcs>
  ...
  sealed inline-only slot printerStatusProc-value :: <QDPrinterStatusUPP>;
...
define C-struct <QDGlobals>
  ...
  sealed inline-only slot randSeed-value :: <C-both-long>,
    address-getter: randSeed-address;
  ...
  sealed inline-only slot thePort-value  :: <GrafPtr>,
    address-getter: thePort-address;
  pack: 2;
...
define inline-only C-function SetPort
  parameter port       :: <GrafPtr>;
  c-name: "SetPort";
  c-modifiers: "pascal";
end;
...
define inline-only C-function InsetRect
  parameter r          :: <Rect*>;
  parameter dh         :: <C-short>;
  parameter dv         :: <C-short>;
  c-name: "InsetRect";
...
define inline-only C-function CopyRgn
...
define inline-only C-function UnionRgn
  parameter srcRgnA    :: <RgnHandle>;
  parameter srcRgnB    :: <RgnHandle>;
  parameter dstRgn     :: <RgnHandle>;
  c-name: "UnionRgn";
...
define inline-only C-function XorRgn
  parameter srcRgnA    :: <RgnHandle>;
  parameter srcRgnB    :: <RgnHandle>;
  parameter dstRgn     :: <RgnHandle>;
  c-name: "XorRgn";
