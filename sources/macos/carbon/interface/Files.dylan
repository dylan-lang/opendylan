...
// unnamed enum:
define inline-only constant $fsCurPerm                 = #x00;
define inline-only constant $fsRdPerm                  = #x01;
define inline-only constant $fsWrPerm                  = #x02;
define inline-only constant $fsRdWrPerm                = #x03;
define inline-only constant $fsRdWrShPerm              = #x04;
define inline-only constant $fsRdDenyPerm              = #x10;
define inline-only constant $fsWrDenyPerm              = #x20;
...
// unnamed enum:
define inline-only constant $pleaseCacheBit            = 4;
define inline-only constant $pleaseCacheMask           = #x0010;
define inline-only constant $noCacheBit                = 5;
define inline-only constant $noCacheMask               = #x0020;
define inline-only constant $rdVerifyBit               = 6;
define inline-only constant $rdVerifyMask              = #x0040;
define inline-only constant $rdVerify                  = 64;
define inline-only constant $newLineBit                = 7;
define inline-only constant $newLineMask               = #x0080;
define inline-only constant $newLineCharMask           = #xFF00;
...
define inline-only constant $kUseWidePositioning       = ash(1, $kWidePosOffsetBit);
...
define inline-only C-function PBHTrashVolumeCachesSync
  parameter paramBlock :: <ParmBlkPtr>;
  result value :: <OSErr>;
  c-name: "PBHTrashVolumeCachesSync";
  c-modifiers: "pascal";
end;
