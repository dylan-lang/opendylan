...
define function context-interactive-sources
...
define method project-current-debug-target-setter
    (debug-target, p :: <interactive-project>)
 => (debug-target)
...
define function %project-close-interactive-context
    (project :: <interactive-project>, #key context = #f)
...
define method project-interactive-execution-notes
    (project :: <interactive-project>, #key record-id)
  let context = project-target-execution-context(project, *current-debug-target*);
