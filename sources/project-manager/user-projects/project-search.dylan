...
//
define method search-for-subproject
    (project :: <user-project>, key :: <symbol>, platform-name)
 => (location)
...
define method note-used-project
    (project :: type-union(<system-project>, <binary-project>),
     subproject :: <project>)
  next-method();
end;
...
define function cache-file-location (project :: <user-project>)
