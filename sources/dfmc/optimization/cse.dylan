...
define method cse-walk-computation
  ...
  let body-state = make(<cse-state>, dominating-state: state);
  cse-walk-computations
...
define method cse-walk-computation
  ...
  let exit-state = make(<cse-state>, dominating-state: state);
...
define method cse-walk-computation
  ...
  let cleanups-state = make(<cse-state>, dominating-state: state);
