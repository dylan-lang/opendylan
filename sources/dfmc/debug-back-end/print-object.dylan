...
define compiler-sideways method print-object
    (o :: <mapped-unbound>, stream :: <stream>) => ()
...
define compiler-sideways method print-object
    (o :: <&generic-function>, stream :: <stream>) => ()
...
define method find-top-level-lambda (o :: <&lambda>)
 => (res :: false-or(<&lambda>))
...
define compiler-sideways method print-object
    (o :: <&single-float>, stream :: <stream>) => ()
  format(stream, "&%=", o.^%single-float-data.^raw-object-value)
end method;

define compiler-sideways method print-object
    (o :: <&double-float>, stream :: <stream>) => ()
