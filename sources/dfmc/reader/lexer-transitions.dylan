  ...
  = compile-state-machine
       ...
       */
       ...
       state(#"double-quote", #f,
             pair('"', #"two-double-quotes"),
             pair('\\', #"string-escape"),
             pair(" !#-[]-~", #"simple-string"),
             pair($ascii-8-bit-extensions, #"simple-string")),
       state(#"simple-string", #f,
             pair('"', #"end-simple-string"),
             pair('\\', #"string-escape"),
             pair(" !#-[]-~", #"simple-string"),
             pair($ascii-8-bit-extensions, #"simple-string")),
       state(#"end-simple-string", make-string-literal),
       state(#"two-double-quotes", make-string-literal,
             pair('"', #"triple-quoted-string")),
       state(#"triple-quoted-string", #f,
             pair('"', #"close-double-quote"),
             pair('\\', #"triple-quoted-string-escape"),
             pair(" !#-[]-~\r\n", #"triple-quoted-string"),
             pair($ascii-8-bit-extensions, #"triple-quoted-string")),
       state(#"triple-quoted-string-escape", #f,
             pair("\\'\"abefnrt0", #"triple-quoted-string"),
             pair('<', #"triple-quoted-string-escape-less")),
       state(#"triple-quoted-string-escape-less", #f,
             pair("0-9a-fA-F", #"triple-quoted-string-hex-char-digits")),
       state(#"triple-quoted-string-hex-char-digits", #f,
             pair("0-9a-fA-F", #"triple-quoted-string-hex-char-digits"),
             pair('>', #"triple-quoted-string")),
       state(#"close-double-quote", #f,
             pair('"', #"close-double-quote-2"),
             pair(" !#-[]-~\r\n", #"triple-quoted-string"),
             pair($ascii-8-bit-extensions, #"triple-quoted-string")),
       state(#"close-double-quote-2", #f,
             pair('"', #"multi-line-string"),
             pair(" !#-[]-~\r\n", #"triple-quoted-string"),
             pair($ascii-8-bit-extensions, #"triple-quoted-string")),
       state(#"multi-line-string", make-multi-line-string-literal),
       state(#"string-escape", #f,
             pair("\\'\"abefnrt0", #"double-quote"),
             pair('<', #"string-escape-less")),
