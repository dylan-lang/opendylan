  ...
  = compile-state-machine
      (state(#"start", #f,
       ...
       state(#"binary-integer", parse-integer-literal,
             pair("01", #"binary-integer"),
             pair('_', #"binary-integer-underscore")),
       ...
       state(#"octal-integer", parse-integer-literal,
             pair("0-7", #"octal-integer"),
             pair('_', #"octal-integer-underscore")),
       ...
       */
       ...
       state(#"dot", fragment-builder(<dot-fragment>),
             pair('.', #"dot-dot"),
             pair("0123456789", #"decimal-dot-decimal")),
       ...
       state(#"signed-decimal", parse-integer-literal,
             ...
             pair('.', #"decimal-dot"),
             pair("eEsSdDxX", #"fp-e"),
             pair('_', #"signed-decimal-underscore")),
       ...
       state(#"decimal-dot", parse-fp-literal,
             pair("0-9", #"decimal-dot-decimal"),
             pair("eEsSdDxX", #"fp-e")),
       state(#"decimal-dot-decimal", parse-fp-literal,
             pair('_', #"decimal-dot-decimal-underscore"),
             pair("0-9", #"decimal-dot"),
             pair("eEsSdDxX", #"fp-e")),
