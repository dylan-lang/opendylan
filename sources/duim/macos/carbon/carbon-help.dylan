Module:       carbon-duim
Synopsis:     Macintosh help implementation
...
define abstract open class <carbon-help-system> (<help-system>)
end class <carbon-help-system>;

define sealed class <carbon-help> (<help-system>)
  keyword name: = "MAC Help";
end class <carbon-help>;
...
*default-help-system* := make(<carbon-help>);
...
define sealed method do-display-help
    (system :: <carbon-help>, handle, path, id, data)
 => ()
  //---*** What should this do?
...
define sealed method help-path
    (system :: <carbon-help-system>, command :: <help-command>)
 => (path :: <string>)
  ""
end method help-path;

define sealed method help-path
    (system :: <carbon-help-system>, command :: <help-from-source>)
 => (path :: <string>)
...
define sealed method help-path-window
    (system :: <carbon-help>, command :: <help-from-source>, path :: <string>)
 => (window :: <string>)
...
define sealed method help-id
    (system :: <carbon-help>, command :: <help-on-index>)
 => (id :: <integer>)
  $HH-DISPLAY-TOPIC
end method help-id;

define sealed method help-id
    (system :: <carbon-help>, command :: <help-on-contents>)
 => (id :: <integer>)
  $HH-DISPLAY-TOPIC
end method help-id;

define sealed method help-id
    (system :: <carbon-help>, command :: <help-on-topics>)
 => (id :: <integer>)
  $HH-DISPLAY-TOPIC
end method help-id;

define sealed method help-id
    (system :: <carbon-help>, command :: <help-on-context>)
 => (id :: <integer>)
  $HH-HELP-CONTEXT
end method help-id;

define sealed method help-id
    (system :: <carbon-help>, command :: <help-on-keyword>)
 => (id :: <integer>)
  $HH-KEYWORD-LOOKUP
end method help-id;
...
define sealed method help-data
    (system :: <carbon-help-system>, command :: <help-on-context>)
 => (data :: <integer>)
  help-topic-id(command)
end method help-data;

define sealed method help-data
    (system :: <carbon-help-system>, command :: <help-on-keyword>)
 => (data :: <machine-word>)
  pointer-address(as(<C-string>, help-keyword(command)))
end method help-data;

define sealed method help-data
    (system :: <carbon-help-system>, command :: <help-run-macro>)
 => (data :: <machine-word>)
...
/*---*** This won't work yet!
define sealed method help-data
    (system :: <carbon-help-system>, command :: <help-reposition>)
 => (data :: <integer>)
