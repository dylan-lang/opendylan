...
define constant $stat-size = 224;
define constant $st-mode-offset = 24;
define constant $st-uid-offset = 28;
define constant $st-gid-offset = 32;
define constant $st-size-offset = 112;
define constant $st-atime-offset = 48;
define constant $st-mtime-offset = 64;
define constant $st-ctime-offset = 80;
