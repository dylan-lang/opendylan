  ...
  every?
    (method (s)
     ...
     list(list(#(), list(), 99),
          ...
          list(range(from: 7, below: 10), list(7, 8, 9), 99),
  ...
  every?
    (method (s)
     ...
     list(list(#(), list(), 99, #f),
          ...
          list(range(from: 7, below: 10), list(7, 8, 9), 99, #f),
  ...
  every?
    (method (s)
     ...
     list(list(list(7, 8, 9), list(7, 8, 9), 8),
          list(range(from: 7, below: 10), list(7, 8, 9), 8),
  ...
  every?
    (method (s)
     ...
     list(list(#(), list(), 17, divides?),
          ...
          list(range(from: 7, below: 10), list(7, 8, 9), 17, divides?),
  ...
  every?
    (method (s)
     ...
     list(list(list(7, 8, 9), list(7, 8, 9), 64, divides?),
          list(range(from: 7, below: 10), list(7, 8, 9), 64, divides?),
  ...
  every?
    (method (s)
     ...
     list(list(#(), list(), 17, #f, divides?),
          ...
          list(range(from: 7, below: 10), list(7, 8, 9), 17, #f, divides?),
