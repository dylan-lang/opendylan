...
:BUILD
@echo Building struct server source files
...
:COMMANDS
	echo.
	echo Step 1 - Run the OrbixWeb server by typing
	echo          [ start server ] 
	echo.
	GOTO END
...
:HELP
        echo.
	echo Compiles the struct server java source files.
	echo.
