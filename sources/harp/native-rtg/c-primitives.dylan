...
define c-runtime-primitive spy-read-thread-variable-at-offset
  ...
  op--load-index-scaled(be, value, tlv-vec, index, 0);
  ins--rts(be);
...
// References to Dylan Objects from C

define c runtime-variable c-dylan-false = "dylan_false", data: dylan-false;

define extensions-constant runtime-external dylan-signal-low-memory     = "signal-low-memory";

define c runtime-variable c-dylan-signal-low-memory = "dylan_signal_low_memory",
  data: dylan-signal-low-memory;

define extensions-constant runtime-external dylan-keyboard-break-handler     = "keyboard-break-handler";

define c runtime-variable c-dylan-keyboard-break-handler = "dylan_keyboard_break_handler",
  data: dylan-keyboard-break-handler;

define c-full-indirect runtime-variable dylan-keyboard-interrupt? = "dylan-keyboard-interrupt?";
