...
define sideways method op--load-index
    (back-end :: <pentium-back-end>, result, base, index, offset :: <integer>)
 => ()
...
define sideways method op--store-index
    (back-end :: <pentium-back-end>, value, base, index, offset :: <integer>)
 => ()
...
define sideways method op--store-index-scaled
    (back-end :: <pentium-back-end>, value, base, scaled-index, offset :: <integer>)
 => ()
