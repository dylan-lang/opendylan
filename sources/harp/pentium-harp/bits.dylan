...
define method pentium-rotate
    (be :: <pentium-back-end>, op :: <integer>, place, amount :: <object>)
...
define method pentium-rotate
    (be :: <pentium-back-end>, op :: <integer>, place, amount :: <integer>)
  unless (zero?(amount))
     emit(be, #xc1);
     emit-m-spill-dest(be, place, op);
...
define method rol2m (be :: <pentium-back-end>, place, amount) 
  pentium-rotate(be, #b000000, place, amount);
end;

define method ror2m (be :: <pentium-back-end>, place, amount) 
