...
define module harp-vars
  ...
  export
    ...
    bind-exit-frame?, bind-exit-frame?-setter,
...
define module harp-templates
  ...
  export   
    ...
    signed-24bit-const-ref,
    signed-16bit-const-ref,
    unsigned-16bit-const-ref,
    unsigned-32bit-const-ref,
    unsigned-5bit-const-ref,
    canonicalise-int,
...
define module main-harp
  ...
  export  
    ...
    code-vector-class,
    compiled-lambda-referenced-data,
    \compiled-lambda-referenced-data-method-definer,
    labelled-constant-code-increment,
