...
define method create-definition-in-container (back-end :: <ir-back-end>, node :: <ast-exception>, container :: corba/<container>)
 => (irobject :: corba/<irobject>)
  ...
  corba/container/create-exception(container, id, name, version, members);
end method;

define method load-deferred-contents (back-end :: <ir-back-end>, node :: <ast-exception>, def :: corba/<ExceptionDef>)
 => ()
  let members = make(corba/<StructMemberSeq>);
  ...
  def.corba/ExceptionDef/members := members;
end method;
