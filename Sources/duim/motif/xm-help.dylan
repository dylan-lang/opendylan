Module:    motif-duim
Synopsis:  Motif help implementation
...
/// Motif Help management

///---*** WHAT ON EARTH DO WE DO ABOUT THIS?

define abstract open class <help-system> (<object>)
  slot help-system-name :: <string>, required-init-keyword: name:;
end class <help-system>;

define sealed class <motif-help> (<help-system>)
  keyword name: = "Motif Help";
end class <motif-help>;
...
*default-help-system* := make(<motif-help>);
...
define sealed method do-display-help
    (system :: <motif-help>, handle, path, id, data)
 => ()
  //---*** What should this do?
...
define sealed method help-path
    (system :: <motif-help-system>, command :: <help-command>)
 => (path :: <string>)
  ""
end method help-path;

define sealed method help-path
    (system :: <motif-help-system>, command :: <help-from-source>)
 => (path :: <string>)
...
define sealed method help-path-window
    (system :: <motif-help>, command :: <help-from-source>, path :: <string>)
 => (window :: <string>)
...
define sealed method help-id
    (system :: <motif-help>, command :: <help-on-index>)
 => (id :: <integer>)
  $HH-DISPLAY-TOPIC
end method help-id;

define sealed method help-id
    (system :: <motif-help>, command :: <help-on-contents>)
 => (id :: <integer>)
  $HH-DISPLAY-TOPIC
end method help-id;

define sealed method help-id
    (system :: <motif-help>, command :: <help-on-topics>)
 => (id :: <integer>)
  $HH-DISPLAY-TOPIC
end method help-id;

define sealed method help-id
    (system :: <motif-help>, command :: <help-on-context>)
 => (id :: <integer>)
  $HH-HELP-CONTEXT
end method help-id;

define sealed method help-id
    (system :: <motif-help>, command :: <help-on-keyword>)
 => (id :: <integer>)
  $HH-KEYWORD-LOOKUP
end method help-id;
...
define sealed method help-data
    (system :: <motif-help-system>, command :: <help-on-context>)
 => (data :: <integer>)
  help-topic-id(command)
end method help-data;

define sealed method help-data
    (system :: <motif-help-system>, command :: <help-on-keyword>)
 => (data :: <machine-word>)
  pointer-address(as(<C-string>, help-keyword(command)))
end method help-data;

define sealed method help-data
    (system :: <motif-help-system>, command :: <help-run-macro>)
 => (data :: <machine-word>)
...
/*---*** This won't work yet!
define sealed method help-data
    (system :: <motif-help-system>, command :: <help-reposition>)
 => (data :: <integer>)
