Module:    motif-duim
Synopsis:  Motif basic clipboard implementation
...
/// Motif clipboard handling

define class <motif-clipboard> (<clipboard>)
  sealed slot clipboard-sheet :: <sheet>,
    required-init-keyword: sheet:;
  sealed slot clipboard-cleared? :: <boolean> = #f;
end class <motif-clipboard>;

define variable *clipboard* :: false-or(<motif-clipboard>) = #f;

define sealed method open-clipboard
    (port :: <motif-port>, sheet :: <sheet>)
 => (clipboard :: false-or(<motif-clipboard>))
...
define sealed method close-clipboard
    (port :: <motif-port>, clipboard :: <motif-clipboard>) => ()
...
define sealed method add-clipboard-data-as
    (type :: subclass(<string>), clipboard :: <motif-clipboard>, data :: <string>)
 => (success? :: <boolean>)
...
define sealed method clipboard-data-available?
    (class :: subclass(<string>), clipboard :: <motif-clipboard>)
 => (available? :: <boolean>)
  ignore(class);
...
define method clipboard-format-available?
    (clipboard :: <motif-clipboard>, format)
 => (available? :: <boolean>)
