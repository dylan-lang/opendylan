Module:       carbon-duim
Synopsis:     Macintosh color and palette implementation
...
define sealed method make-palette
    (_port :: <carbon-port>, #key color?, dynamic?, colormap, #all-keys)
...
define sealed method palette-depth
    (palette :: <carbon-palette>) => (depth :: <integer>)
...
define sealed method allocate-color 
    (color :: <color>, palette :: <carbon-palette>)
 => (pixel :: <integer>)
...
define sealed method do-allocate-color
    (palette :: <carbon-palette>, color :: <rgb-color>)
 => (pixel :: <integer>)
  let x-display = port(palette).%display;
...
define sealed method do-allocate-color
    (palette :: <carbon-palette>, color :: <contrasting-color>)
 => (pixel :: <integer>)
  let x-display = port(palette).%display;
  let colormap  = palette.%colormap;
...
define sealed method do-allocate-color
    (palette :: <carbon-palette>, color :: <dynamic-color>)
 => (pixel :: <integer>)
...
define sealed method find-color
    (name, palette :: <carbon-palette>, #key error? = #t)
 => (color :: <rgb-color>)
  let _port     = port(palette);
