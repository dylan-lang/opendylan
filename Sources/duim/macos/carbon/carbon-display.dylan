Module:       carbon-duim
Synopsis:     Macintosh display implementation
...
/// MAC displays, i.e., the screen

define constant $points-per-mm = 72.0 / 25.4;

define sealed class <display-mirror> (<carbon-mirror>)
...
define method size-mirror
 ...
 => ()
  ignoring("size-mirror for <top-level-mirror>")
