...
! $HopeName: D-gnu-glib!patterns.pat(trunk.1) $
! $Date: 2004/03/12 00:08:24 $
...
do-typedef:*\d*=\Ndefine C-pointer-type @export{\<@map-ptr-name{$1}\>} \=\>\ @type{$1}\;\n\
...
enumbody:<I>\W\=\W<number>=define inline-only constant @export{\$$1} \= \
		$2\;\n@set{prev;$2}
enumbody:<I>\W\=\W\'<char>\'=define inline-only constant @export{\$$1} \= \
		as(\<integer\>, \'$2\')\;\n@set{prev;$2}
...
putparm:<G>,*=parameter @argname{$1} @tab{24}\:\: $2\;\n
