...
define method fpu-duplicate (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11000000);
end method;
						       
// define method fpu-push-0 (be :: <pentium-back-end>)
//   emit(be, #b11011001, #b11101110);
// end method;

define method fpu-push-1 (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11101000);
end method;

// define method fpu-push-pi (be :: <pentium-back-end>)
//   emit(be, #b11011001, #b11101011);
// end method;

// define method fpu-push-log2-10 (be :: <pentium-back-end>)
//   emit(be, #b11011001, #b11101001);
// end method;

define method fpu-push-log2-e (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11101010);
end method;

// define method fpu-push-loge-10 (be :: <pentium-back-end>)
//   emit(be, #b11011001, #b11101100);
// end method;

define method fpu-push-loge-2 (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11101101);
end method;

define method fpu-push-2 (be :: <pentium-back-end>)
  fpu-push-1(be); fpu-duplicate(be); fpu-add(be);
end method;
					  
define method fpu-add (be :: <pentium-back-end>)
  emit(be, #b11011110, #b11000001);
end method;

define method fpu-sub (be :: <pentium-back-end>)
  emit(be, #b11011110, #b11101001);
end method;

define method fpu-subr (be :: <pentium-back-end>)
  emit(be, #b11011110, #b11100001);
end method;

define method fpu-mul (be :: <pentium-back-end>)
  emit(be, #b11011110, #b11001001);
end method;

define method fpu-div (be :: <pentium-back-end>)
  emit(be, #b11011110, #b11111001);
end method;

define method fpu-divr (be :: <pentium-back-end>)
  emit(be, #b11011110, #b11110001);
end method;

define method fpu-halve (be :: <pentium-back-end>)
  fpu-push-2(be); fpu-div(be);
end method;
					  
define method fpu-sqrt (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11111010);
end method;

define method fpu-discard (be :: <pentium-back-end>)
  emit(be, #b11011101, #b11011000);
end method;

define method fpu-pop-down (be :: <pentium-back-end>)
  emit(be, #b11011101, #b11011001);
end method;

define method fpu-exch (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11001001);
end method;

define method fpu-exch2 (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11001010);
end method;

define method fpu-round (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11111100);
end method;

define method fpu-extract (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11110100);
end method;

define method fpu-scale (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11111101);
end method;

define method fpu-raise-mant (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11110000);
end method;

define method fpu-logarithm (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11110001);
end method;

define method fpu-raw-tan (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11110010);
end method;

define method fpu-raw-arctan (be :: <pentium-back-end>)
  emit(be, #b11011001, #b11110011);
end method;
					  
define method fpu-tan (be :: <pentium-back-end>)
  fpu-raw-tan(be); fpu-discard(be);
end method;

define method fpu-atan (be :: <pentium-back-end>)
  fpu-push-1(be);  fpu-raw-arctan(be);
end method;
					  
define method fpu-raise (be :: <pentium-back-end>)
...
define method fpu-atanh (be :: <pentium-back-end>)
...
define method push-float (be :: <pentium-back-end>, d, s)
  if (d) push-double(be, s) else push-single(be, s) end;
end method;

define method pop-float (be :: <pentium-back-end>, d, s)
...
/*
define method pop-and-discard (be :: <pentium-back-end>)
...
define method push-const (be :: <pentium-back-end>, i387-bits :: <integer>)
...
/*
define method emit-fpu-duplicate (be :: <pentium-back-end>)
