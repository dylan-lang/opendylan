...
define constant <TARGET-ADDRESS>       = <C-both-int>;
define constant <REMOTE-ARG-ARRAY>     = <C-both-int*>;
define constant <POINTER-VECTOR>       = <C-both-int*>;
...
define C-function attach-remote-tether
