...
//--- Even less policy than a pinboard layout!
define class <no-layout-pane> (<layout-pane>)
end class <no-layout-pane>;

define method do-compose-space 
    (pane :: <no-layout-pane>, #key width, height)
 => (space-req :: <space-requirement>)
  default-space-requirements(pane, width: width, height: height)
end method do-compose-space;

define method do-allocate-space
    (pane :: <no-layout-pane>, width :: <integer>, height :: <integer>) => ()
  ignore(pane, width, height);
  #f
