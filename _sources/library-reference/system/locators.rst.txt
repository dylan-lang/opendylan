...
.. generic-function:: resolve-locator
   ...
   .. deprecated:: 2026.2
      ...
      :gf:`resolve-locator` is deprecated and should be replaced by calls to (or methods
      on) :gf:`resolve-file`.  This generic function remains for backward compatibility
